# 📘 Marie Chat - Technical Specifications
...
|------------|---------|---------|
| **Next.js** | 15.1.x (stable) | Fullstack framework (includes React 19) |
| **TypeScript** | 5.x | Static typing |
| **Ant Design X** | 2.1.x | AI chat components (RICH paradigm) |
| **Ant Design** | 5.x | Base UI components |
...
| RF09.5 | General system configuration | High |
...
Marie Chat supports rendering HTML artifacts generated by LLMs, particularly for data visualizations, plots, and interactive charts. This is essential for displaying outputs from code execution, especially Python scripts that generate matplotlib, Plotly, Bokeh, or other visualization libraries.
...
Marie Chat soporta la carga y procesamiento de archivos para incluirlos en el contexto de las conversaciones. Los archivos se procesan, se extrae su contenido y se incluye en el prompt enviado al LLM.
...
Marie Chat allows referencing previous conversations in new conversations, allowing the LLM to have context from previous conversations without needing to copy and paste content manually.
...
Marie Chat implementa un sistema de memoria conversacional que permite recordar información importante sobre el usuario y las conversaciones, manteniendo contexto entre sesiones y soportando múltiples idiomas.
...
Marie Chat genera automáticamente preguntas de seguimiento relevantes después de cada respuesta del asistente, permitiendo que el usuario continúe la conversación de manera natural.
...
Marie Chat mantiene un historial completo y navegable de todas las conversaciones, permitiendo a los usuarios revisar, buscar y navegar fácilmente por sus chats anteriores.
...
Marie Chat muestra sugerencias de preguntas al inicio de cada conversación, ayudando a los usuarios a comenzar de manera productiva.
  ...
  return (
    <div className="welcome-screen">
      <div className="welcome-header">
        <Title level={2}>
          <BulbOutlined /> ¡Hola! Soy Marie Chat
        </Title>
        <Text type="secondary">
...
| Característica | Beneficio para Marie Chat |
|----------------|---------------------------|
...
Marie Chat soporta dos tipos de autenticación según el tipo de API:
...
Marie Chat ofrece dos tipos de APIs:
...
La API de Usuario está diseñada para ser consumida por el frontend de Marie Chat. Utiliza autenticación JWT y WebSockets para streaming en tiempo real.
...
- [ ] **Project Setup**
  ...
  - [ ] Initialize Flask with modular structure
  - [ ] Configure OpenSearch (indices and mappings)
  - [ ] Setup Docker Compose with OpenSearch

- [ ] **Basic Authentication**
  - [ ] OpenSearch service for Users
  - [ ] register/login/logout endpoints
  - [ ] JWT setup with Flask-JWT-Extended
  - [ ] login/register forms in frontend
  - [ ] AuthGuard and route protection

### Phase 2: Chat Core (Days 3-4)
- [ ] **Backend Chat**
  - [ ] OpenSearch indices: conversations, messages
  - [ ] Conversation CRUD with OpenSearch
  - [ ] Basic integration with Ollama
  - [ ] WebSocket with Flask-SocketIO
  - [ ] Response streaming

- [ ] **Frontend Chat**
  - [ ] ChatContainer with Ant Design X
  - [ ] MessageList and MessageBubble
  - [ ] ChatInput with Sender component
